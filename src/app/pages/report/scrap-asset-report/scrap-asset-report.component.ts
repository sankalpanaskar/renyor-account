...
@Component({
  selector: 'ngx-scrap-asset-report',
  templateUrl: './scrap-asset-report.component.html',
  styleUrls: ['./scrap-asset-report.component.scss']
})
export class ScrapAssetReportComponent {
  ...
  onSubmit(fm) {
    if (fm.valid) {
      ...
      this.globalService.scrapAssetReport(fm.value).subscribe({
        next: (res) => {
          console.log(res);
          //fm.resetForm();
