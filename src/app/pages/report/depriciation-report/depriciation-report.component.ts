...
@Component({
  selector: 'ngx-depriciation-report',
  templateUrl: './depriciation-report.component.html',
  styleUrls: ['./depriciation-report.component.scss']
})
export class DepriciationReportComponent {
  ...
  onSubmit(fm) {
    if (fm.valid) {
      ...
      this.globalService.depriciationReport(fm.value).subscribe({
        next: (res) => {
          console.log(res);
          //fm.resetForm();
