...
@Component({
  selector: 'ngx-not-working-asset-report',
  templateUrl: './not-working-asset-report.component.html',
  styleUrls: ['./not-working-asset-report.component.scss']
})
export class NotWorkingAssetReportComponent {
  ...
  onSubmit(fm) {
    if (fm.valid) {
      ...
      this.globalService.notWorkingAssetReport(fm.value).subscribe({
        next: (res) => {
          console.log(res);
          //fm.resetForm();
